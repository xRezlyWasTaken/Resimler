...
module.exports = {
  ...
  run: async (client, interaction, message) => {
    ...
    const embed = new EmbedBuilder()
      .setAuthor({ name: 'Versty', iconURL: client.user.avatarURL() })
      .setTitle('Ana Sayfa')
      .setColor(0x00ffff)
      .setDescription(`
      [Yönetim](https://discord.gg/mW8Fecu2) **⇝** Yönetim Komutları
      [Eğlence](https://discord.gg/mW8Fecu2) **⇝** Eğlence Komutları
      [Bot](https://discord.gg/mW8Fecu2) **⇝** Bot Komutları
      [Koruma](https://discord.gg/mW8Fecu2) **⇝** Koruma Komutları
      [Kullanıcı](https://discord.gg/mW8Fecu2) **⇝** Kullanıcı Komutları
      [Sistemler](https://discord.gg/mW8Fecu2) **⇝** Sistemleri Ayarlama Sayfası
      ...
      **• Linkler:**
      • [Davet Et](https://discord.com/oauth2/authorize?client_id=784899334109659196&scope=bot&permissions=8) • [Destek Sunucusu](https://discord.gg/Ay852SnqCn) •
      `)
      .setImage("https://cdn.discordapp.com/attachments/987306105367588934/1158824207858290718/standard.gif?ex=651da6a5&is=651c5525&hm=50743617169134fdcc2fed88f6b1be2447ed79cff330d9b6c956e019d3329f86&")
      .setTimestamp()
      .setThumbnail(interaction.user.avatarURL())
      .setFooter({ text: 'Versty', iconURL: interaction.user.avatarURL() })
      ...
      if (interaction.customId === 'select') {
        ...
        if (choices == 'mod') {
          ...
          **• Linkler:**
          • [Davet Et](https://discord.com/oauth2/authorize?client_id=784899334109659196&scope=bot&permissions=8) • [Destek Sunucusu](https://discord.gg/Ay852SnqCn) •
          `)
            .setImage("https://media.discordapp.net/attachments/987306105367588934/1158824207858290718/standard.gif")
            .setTimestamp()
            .setThumbnail(interaction.user.avatarURL())
            .setFooter({ text: 'Versty', iconURL: interaction.user.avatarURL() })
          ...
          **• Linkler:**
          ...
          </webhook-koruma:> **⇝**  Webhook Koruma Sistemi
